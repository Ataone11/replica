...
const Silver = () => {
  ...
  useEffect(() => {
    if (!plans) {
      getPlans(dispatch, `61a40bd690482b0f7cc8ca7b`);
    }
    console.log(plans);
  }, [plans]);
  ...
  return (
    <section>
      ...
      <div className="grid grid-cols-1  md:grid-cols-2 gap-x-5 gap-y-5 pt-20 md:pt-40 h-full w-full">
        <div className="pl-5 md:pl-80">
          <img src={silver} className="w-[90%] h-[90%] scale-100" alt="" />
        </div>
        <div className="justify-around container w-full md:w-[60%] h-[50%] md:pl-5 text-xl text-black pl-10">
          ...
          <a
            href="/mas"
            className=" bg-primary bg-opacity-80 hover:bg-opacity-100 text-white transition duration-200 group text-lg my-4 inline-block py-2 px-24"
          >
            Add to Bag
          </a>
